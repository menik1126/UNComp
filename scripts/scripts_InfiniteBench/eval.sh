...
gpu_id="/home/avnet/xiongjing/UNComp/scripts/scripts_InfiniteBench/gpu${gpu_id}.yaml"
save_dir="${source_path}results_Inifite_bench"
accelerate launch --config_file $gpu_id --main_process_port $port run_infinitebench.py \
    --method ${method} \
    --seed ${seed} \
